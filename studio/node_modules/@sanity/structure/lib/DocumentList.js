...
function inferInitialValueTemplates(spec) {
  ...
  var typeName = schemaTypeName || getTypeNameFromSingleTypeFilter(filter, params);

  if (!typeName) {
    return undefined;
  }

  return (0, _initialValueTemplates.getParameterlessTemplatesBySchemaType)(typeName).map(tpl => ({
